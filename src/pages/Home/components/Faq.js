...
export const Faq = () => {
    const faqs = [
        ...
        {
          "id": 4,
          "question": "Prenez-vous en charge les paiements internationaux ?",
          "answer": "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse iste dolor deserunt expedita quam fugit et inventore amet pariatur. Animi."
        }
    ];
  ...
  return (
    <section className="my-10 p-7 border rounded dark:border-slate-700 shadow-sm">        
      <h1 className="text-2xl text-center font-semibold dark:text-slate-100 mb-3 underline underline-offset-8">Une question en tête ?</h1>    
